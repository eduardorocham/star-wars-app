            ...
            <section className='vehicle_Page'>
                ...
                <div className='vehiclePage_data'>
                    ...
                    <div className='vehiclePage_infos'>
                        ...
                        <div className='vehiclePage_infos-right'>
                            <div className='vehiclePage_info'><span>Crew:</span>{vehicle?.crew}</div>
                            <div className='vehiclePage_info'><span>Passengers:</span>{vehicle?.passengers}</div>
                            <div className='vehiclePage_info'><span>Cargo Capacity:</span>{vehicle?.cargo_capacity}</div>
                            <div className='vehiclePage_info'><span>Consumables:</span>{vehicle?.consumables}</div>
                        </div>
                    </div>
                </div>
            </section>
